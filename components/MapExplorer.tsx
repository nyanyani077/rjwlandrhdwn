                ...
                return (
                  <li key={r.id} className="mb-1">
                    ...
                    >
                      ...
                      {selected && r.menus.length > 0 && (
                        <div className="border-t border-stone-100/90 px-2 pb-2 pt-1 sm:px-3">
                          <ul className="space-y-1.5 rounded-md bg-stone-50/90 px-2 py-2 text-left text-xs text-stone-700 sm:px-3 sm:py-3 sm:text-sm">
                            {r.menus.map((m, idx) => (
                              <li
                                key={`${r.id}-m-${idx}`}
