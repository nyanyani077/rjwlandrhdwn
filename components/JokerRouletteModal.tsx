      ...
      >
        <header className="grid grid-cols-[2.5rem_1fr_2.5rem] items-start gap-1">
          ...
          <div className="col-start-2 text-center">
            ...
            <p className="mt-1 text-xs text-[#5c4033]/75">
              오늘 뭐 먹을지 고민인 당신, 조커를 뽑아봐!
            </p>
          </div>
          <button
            ref={closeRef}
        ...
        <div
          className={`mt-7 flex items-start gap-6 ${
            showPick ? "flex-row" : "flex-col items-center"
          }`}
        >
          <div className="flex w-64 shrink-0 flex-col items-center">
            <div className="pointer-events-none relative z-20 mb-[-2px] flex justify-center">
              <svg
                width="36"
                height="22"
                viewBox="0 0 36 22"
            ...
            <div className="relative h-64 w-64 shrink-0">
              <div
                className="absolute inset-0 rounded-full shadow-md ring-[3px] ring-[#5c4033]"
                style={{
